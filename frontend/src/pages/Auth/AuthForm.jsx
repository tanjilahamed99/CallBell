...
import { Eye, EyeOff, User, Mail, Lock, QrCode, Type } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {signUp && (
                <>
                  ...
                  <div className="relative group">
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                      <Type className="h-5 w-5 text-gray-400 transition-colors duration-200 group-focus-within:text-red-500" />
                    </div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="group w-full appearance-none rounded-xl border border-gray-800 bg-gray-900/60 py-3.5 pl-12 pr-12 text-white shadow-sm transition-all duration-200 
               ...
               disabled:cursor-not-allowed disabled:opacity-50"
                      ...
                      <option
                        value="user"
                        className="bg-gray-900 py-2 text-white">
                        User
                      </option>
                      <option
                        value="distributor"
                    ...
                    {/* Custom dropdown arrow - now the only visible one */}
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                      <svg
                        className="h-5 w-5 text-gray-400 transition-colors duration-200 group-hover:text-gray-300 group-focus-within:text-red-500"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true">
              ...
              {!signUp && (
                <div className="text-center">
                  <p className="text-sm text-gray-400">
                    <Link
                      to="/forget-password"
                      className="hover:text-red-500 transition-colors duration-200 hover:underline">
                      Forgot password?
                    </Link>
                  </p>
                </div>
